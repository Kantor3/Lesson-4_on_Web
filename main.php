...
// Урок 4. Основы бэкенда: PHP и MySQL - ДЗ
...
$workExperience = [
    [
        ...
        'Period' => 'July 2022 -',
        'Officia' => 'Software development for analyzing research data and performing experimental calculations',
    ],
    [
        'Position' => 'Freelancer',
        'Period' => 'April 2019 - June 2022',
        'Officia' => 'Revision and maintenance of accounting systems of clients using the 1C: Enterprise platform',
    ],
    [
        'Position' => 'Project Manager / Director of training center',
        'Period' => 'September 2004 - April 2019',
        'Officia' => 'Project management of implementation and maintenance of accounting systems in large and medium-sized enterprises on the 1C: Enterprise platform',
    ],
    [
        'Position' => 'Entrepreneur',
        'Period' => 'November 1995 - August 2004',
        'Officia' => 'Development, implementation, maintenance of accounting systems on different software platforms',
    ],
];
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i=0; $i < count($workExperience); $i++): 
                    $period = $workExperience[$i]['Period'];
                    $lastSymbol = mb_substr($period, -1, 1);
          ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?= $workExperience[$i]['Position']; ?> </b></h5>
